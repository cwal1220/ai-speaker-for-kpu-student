...
def get_weather(lat, lon):
	...
	sky_code = result['weather']['summary'][0]['today']['sky']['name']
	sky_code_str = result['weather']['summary'][0]['today']['sky']['code']
	...
	info_dict = {'addr': addr, 't_temp': temperature, 't_max': tmax, 't_min': tmin, 'sky_code':sky_code, 'sky_name': sky_code_str, 'dust': dust, 'tomorrow': tomorrow_info, 'str': get_weather_str(addr, temperature, tmax, tmin, sky_dict[sky_code], dust, dust_str)}
